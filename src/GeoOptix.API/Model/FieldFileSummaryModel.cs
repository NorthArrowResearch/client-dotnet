...
{
    public class FieldFileSummaryModel : IHasUrl
    {
        [JsonProperty("name")]
        ...
        [Obsolete] public FieldFileSummaryModel() { }

        public FieldFileSummaryModel(string name, string description, long size, string folderUrl, string url, int componentTypeID, int? notMeasuredReasonID, string notMeasuredReason, string notMeasuredReasonNote, string groupName)
        {
            Name = name;
